...
struct DocxImportProvider: ImportProvider {
    static let supportedTypes: [UTType] = [UTType(filenameExtension: "docx")!]
    ...
    func process(data: Data, filename: String, progress: @Sendable (Double) -> Void) async throws -> ImportResult {
        ...
        do {
            ...
            throw ImportError.parseFailed("DOCX parsing failed: \(error.localizedDescription)")
        }
